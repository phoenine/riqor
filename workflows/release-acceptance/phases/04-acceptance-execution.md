...
**Skills:** `automation`, `test-execution`, `release-acceptance`; load only the
project-specific automation or data-preparation Skills selected by the Project Profile.
...
normalized `execution_record` or `execution_evidence:` / `data_injection:` / skip —
