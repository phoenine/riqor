...
python3 tools/copy_template.py \
  ...
  --destination outputs/v2/reports/<feature>-run-summary.md
```
...
| `bug-report` | `bug_report` | Confirmed failure draft before ZenTao sync |
...
- Do not create or update ZenTao records; use `epvs-zentao-sync`.
