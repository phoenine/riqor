---
name: epvs-requirement
description: Requirement intake and specification skill for agent-next. Use when reading PRD, Feishu/Lark documents, ZenTao requirements or tasks, feature descriptions, bug context, release scope inputs, or producing requirement specifications and requirement summaries.
---
...
- PRD or Feishu/Lark document.
- ZenTao requirement, task, bug, or version context.
- User-provided feature, bug, or release scope.
- Repository evidence from `repositories/dev/` when code context is
  required.
...
python3 tools/copy_template.py \
  ...
  --destination outputs/v2/requirements/<feature>-requirement-spec.md
```
...
python3 tools/validate_artifact.py \
  --artifact-file outputs/v2/requirements/<feature>-requirement-spec.md \
