...
- Reuse and migration decisions: `docs/agent-next-reuse-alignment-audit-v0.1.md`
...
1. Reuse Agent-next before implementing. Search the alignment audit and the
   corresponding Agent-next Workflow, Skill, Tool, Template, and tests before
   adding a new implementation. Parameterize existing behavior when possible.
